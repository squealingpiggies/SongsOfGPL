...
function d.load()
	...
	-- food needs
	make_use_case("food", "food", "high-grass.png", 0.12, 0.91, 0.24)
	make_use_case("meat", "meat", "meat.png", 1, 0.1, 0.1)

	-- clothing needs
	make_use_case("accessories", "ordimental extras", "primitive-necklace.png", 0.6, 0.6, 0.6)
	...
	--luxury needs
	make_use_case("jewelry", "gaudy accessories", "tribal-pendant.png", 0.74, 0.78, 0.80)
