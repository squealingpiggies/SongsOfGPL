...
local function get_main_panel()
	...
	local panel = fs:subrect(ut.BASE_HEIGHT * 2, ut.BASE_HEIGHT * 2, ut.BASE_HEIGHT * 15, fs.height - ut.BASE_HEIGHT * 2,
		"left", "up")
	return panel
end
	...
	buildings_scroll = ut.scrollview(
		...
		function(number, rect)
			...
			if number > 0 then
				...
				-- drawing the button
				local result, rect_data = ut.button(rect, buildable[building_type],
