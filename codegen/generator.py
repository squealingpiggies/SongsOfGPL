...
WarbandStatus = StaticEntityDescription("estate_status")
WarbandStance = StaticEntityDescription("estate_stance")
...
Estate = EntityDescription("estate", POPS_MAX_COUNT, False)
Ownership = EntityDescription("ownership", POPS_MAX_COUNT, False)
Employment = EntityDescription("employment", POPS_MAX_COUNT * 2, False)
EstateLocation = EntityDescription("estate_location", POPS_MAX_COUNT, False)
BuildingEstate = EntityDescription("building_estate", POPS_MAX_COUNT * 20, False)

EstateUnit = EntityDescription("estate_unit", POPS_MAX_COUNT, False)
EstateLeader = EntityDescription("estate_leader", 50000, False)
EstateRecruiter = EntityDescription("estate_recruiter", 50000, False)
EstateCommander = EntityDescription("estate_commander", 50000, False)
